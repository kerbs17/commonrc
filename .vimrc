...
map <F9> <esc>:set mouse=a<cr>:set nopaste<cr>
map! <F9> <esc>:set mouse=a<cr>:set nopaste<cr>a

map  <F10> <esc>:set mouse=<cr>:set paste<cr>
map! <F10> <esc>:set mouse=<cr>:set paste<cr>a

map! <F11> <esc>:set nonumber<cr>a
map  <F11> <esc>:set nonumber<cr>

map! <F12> <esc>:set number<cr>a
map  <F12> <esc>:set number<cr>

imap ,dd <C-O>:call InsertDumper()<CR><end>
map ,dd :call InsertDumper()<CR><end>
